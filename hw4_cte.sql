...
select top 10 * from sales.Customers--ключ diliveryCityID (таблица покупателей)
select top 10 * from Application.People --- сотрудник person id
select top 10 * from Sales.OrderLines --- ключ Stockitemid  (упаковщик)
select top 10 * from Warehouse.StockItems  --- товары
